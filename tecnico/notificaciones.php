...
<title>EVA - Notificaciones</title>
...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <li class="active anim-slide10"><a href="notificaciones.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg><span>Notificaciones</span></a></li>
...
<div class="main">
 <header class="header">
  <div class="header-left" style="display:flex;align-items:center;gap:12px"><button class="menu-btn" aria-label="Abrir menu"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button><div><div class="header-greeting">Notificaciones</div><div class="header-subtitle">Avisos y recordatorios del sistema</div></div></div>
  ...
  <div class="content-card anim-bounce0">
   <div class="card-header">
    ...
    <div class="filtros-inline">
     <input class="form-input filtros-buscar" type="text" placeholder="Buscar notificaciones..." id="buscarNotificaciones">
     <button class="btn btn-sm btn-outline" onclick="marcarTodasLeidas()">Marcar todas como leidas</button>
    </div>
   </div>

   <div class="notificaciones-lista">
    <div class="notificacion-item no-leida" data-tipo="asignacion">
     <div class="notificacion-icono blue"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="4" y="4" width="16" height="16" rx="2"/><rect x="9" y="9" width="6" height="6"/><line x1="9" y1="1" x2="9" y2="4"/><line x1="15" y1="1" x2="15" y2="4"/><line x1="9" y1="20" x2="9" y2="23"/><line x1="15" y1="20" x2="15" y2="23"/></svg></div>
     <div class="notificacion-contenido">
      <div class="notificacion-titulo">Nuevo dispositivo asignado</div>
      <div class="notificacion-texto">Se te ha asignado el Sensor de Flujo 06 para su instalacion en Tanque Norte.</div>
      <div class="notificacion-fecha">14/07/2026 08:00</div>
     </div>
     <button class="btn btn-sm btn-outline" onclick="marcarLeida(this)">Marcar leida</button>
    </div>

    <div class="notificacion-item no-leida" data-tipo="alerta">
     <div class="notificacion-icono red"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg></div>
     <div class="notificacion-contenido">
      <div class="notificacion-titulo">Alerta de nivel critico</div>
      <div class="notificacion-texto">El Tanque Norte ha alcanzado un nivel critico del 15%. Requiere atencion inmediata.</div>
      <div class="notificacion-fecha">14/07/2026 08:15</div>
     </div>
     <button class="btn btn-sm btn-outline" onclick="marcarLeida(this)">Marcar leida</button>
    </div>

    <div class="notificacion-item no-leida" data-tipo="alerta">
     <div class="notificacion-icono orange"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg></div>
     <div class="notificacion-contenido">
      <div class="notificacion-titulo">Bateria baja</div>
      <div class="notificacion-texto">El Sensor de Nivel 03 tiene la bateria al 22%. Considera reemplazarla proximamente.</div>
      <div class="notificacion-fecha">14/07/2026 07:30</div>
     </div>
     <button class="btn btn-sm btn-outline" onclick="marcarLeida(this)">Marcar leida</button>
    </div>

    <div class="notificacion-item leida" data-tipo="mantenimiento">
     <div class="notificacion-icono orange"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"/></svg></div>
     <div class="notificacion-contenido">
      <div class="notificacion-titulo">Recordatorio de mantenimiento</div>
      <div class="notificacion-texto">Tienes programado un mantenimiento preventivo para el Sensor de Presion 02 el 16/07/2026.</div>
      <div class="notificacion-fecha">13/07/2026 16:00</div>
     </div>
     <button class="btn btn-sm btn-outline" onclick="marcarLeida(this)">Marcar leida</button>
    </div>

    <div class="notificacion-item leida" data-tipo="admin">
     <div class="notificacion-icono blue"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></div>
     <div class="notificacion-contenido">
      <div class="notificacion-titulo">Aviso del administrador</div>
      <div class="notificacion-texto">Se ha actualizado el protocolo de instalacion. Revisa los nuevos lineamientos en la documentacion.</div>
      <div class="notificacion-fecha">12/07/2026 10:00</div>
     </div>
     <button class="btn btn-sm btn-outline" onclick="marcarLeida(this)">Marcar leida</button>
    </div>

    <div class="notificacion-item leida" data-tipo="asignacion">
     <div class="notificacion-icono green"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div>
     <div class="notificacion-contenido">
      <div class="notificacion-titulo">Instalacion completada</div>
      <div class="notificacion-texto">La instalacion del Sistema EVA en Tanque Centro ha sido marcada como completada exitosamente.</div>
      <div class="notificacion-fecha">11/07/2026 14:30</div>
     </div>
     <button class="btn btn-sm btn-outline" onclick="marcarLeida(this)">Marcar leida</button>
    </div>
    ...
    <div class="notificacion-item leida" data-tipo="mantenimiento">
     <div class="notificacion-icono orange"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"/></svg></div>
     <div class="notificacion-contenido">
      <div class="notificacion-titulo">Mantenimiento pendiente</div>
      <div class="notificacion-texto">El mantenimiento del Sensor Ultrasonico 01 esta vencido desde el 10/07/2026. Programa su revision.</div>
      <div class="notificacion-fecha">10/07/2026 08:00</div>
     </div>
     <button class="btn btn-sm btn-outline" onclick="marcarLeida(this)">Marcar leida</button>
    </div>

    <div class="notificacion-item leida" data-tipo="admin">
     <div class="notificacion-icono blue"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg></div>
     <div class="notificacion-contenido">
      <div class="notificacion-titulo">Actualizacion del sistema</div>
      <div class="notificacion-texto">El sistema EVA sera actualizado este fin de semana. Puede haber intermitencias temporales.</div>
      <div class="notificacion-fecha">09/07/2026 09:00</div>
     </div>
     <button class="btn btn-sm btn-outline" onclick="marcarLeida(this)">Marcar leida</button>
    </div>
   </div>
