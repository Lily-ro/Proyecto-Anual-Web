...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <li class="anim-slide6" data-toggle="inst"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg><span>Instalación</span><span class="arrow">▶</span></li>
   ...
   <li class="anim-slide7"><a href="historialtecnico.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg><span>Histórico Técnico</span></a></li>
...
<div class="main">
 <header class="header">
  <div class="header-left"><div class="header-greeting">Agregar Sensor</div><div class="header-subtitle">Registra un nuevo sensor en el sistema</div></div>
 ...
 <div class="content">
  <div class="content-card anim-bounce0">
   ...
   <div class="form-group"><label class="form-label">Nombre del sensor</label><input class="form-input" type="text" placeholder="Ej: Sensor Ultrasónico 05"></div>
   <div class="form-row">
    <div class="form-group"><label class="form-label">Tipo</label><select class="form-select"><option>Ultrasónico</option><option>Presión</option><option>Nivel</option><option>Temperatura</option><option>Flujo</option></select></div>
    <div class="form-group"><label class="form-label">Ubicación</label><select class="form-select"><option>Tanque Norte</option><option>Tanque Centro</option><option>Tanque Sur</option><option>Tanque Este</option><option>Tanque Oeste</option></select></div>
   </div>
