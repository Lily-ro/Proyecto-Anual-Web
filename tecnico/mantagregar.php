...
<title>EVA - Agregar Sensor</title>
...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <li class="open anim-slide5" data-toggle="mant"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"/></svg><span>Mantenimiento</span><span class="arrow">â–¶</span></li>
   <ul class="sub-menu open"><li><a href="mantagregar.php" style="font-weight:600">Agregar sensor</a></li><li><a href="manteliminar.php">Eliminar sensor</a></li></ul>
   <li class="anim-slide6" data-toggle="inst"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg><span>InstalaciÃ³n</span><span class="arrow">â–¶</span></li>
   <ul class="sub-menu"><li><a href="instprogramar.php">Programar instalaciÃ³n</a></li><li><a href="instalar.php">Instalar sistema EVA</a></li></ul>
   <li class="anim-slide7"><a href="historialtecnico.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg><span>HistÃ³rico TÃ©cnico</span></a></li>
   <li class="anim-slide8"><a href="notificaciones.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg><span>Notificaciones</span></a></li>
   <li class="anim-slide9"><a href="perfil.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg><span>Perfil</span></a></li>
  </ul>
 </nav>
...
<div class="main">
 <header class="header">
  <div class="header-left" style="display:flex;align-items:center;gap:12px"><button class="menu-btn" aria-label="Abrir menu"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button><div><div class="header-greeting">Agregar Sensor</div><div class="header-subtitle">Registra un nuevo sensor en el sistema</div></div></div>
 ...
 <div class="content">
  <div class="content-card anim-bounce0">
   <div class="card-title">Agregar Sensor</div>
   <div class="card-subtitle">Completa los datos para registrar un nuevo sensor</div>
   <div class="content-divider"></div>
   <div class="form-group"><label class="form-label">Nombre del sensor</label><input class="form-input" type="text" placeholder="Ej: Sensor UltrasÃ³nico 05"></div>
   <div class="form-row">
    <div class="form-group"><label class="form-label">Tipo</label><select class="form-select"><option>UltrasÃ³nico</option><option>PresiÃ³n</option><option>Nivel</option><option>Temperatura</option><option>Flujo</option></select></div>
    <div class="form-group"><label class="form-label">UbicaciÃ³n</label><select class="form-select"><option>Tanque Norte</option><option>Tanque Centro</option><option>Tanque Sur</option><option>Tanque Este</option><option>Tanque Oeste</option></select></div>
   </div>
   <div class="form-group"><label class="form-label">Modelo</label><input class="form-input" type="text" placeholder="Ej: EVA-US-200"></div>
   <div class="actions-row"><button class="btn btn-primary">Agregar Sensor</button><button class="btn btn-outline">Cancelar</button></div>
  </div>
 </div>
</div>
