...
<title>EVA - Dashboard Técnico</title>
...
=======
 <a href="../cliente/indexcli.html" class="sidebar-logo">
<svg class="logo-svg" width="37" height="53" viewBox="0 0 37 53" fill="none" xmlns="http://www.w3.org/2000/svg">
 ...
 <nav>
  <ul>
   ...
   <li class="anim-slide2" data-toggle="mant">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"/></svg>
    <span>Mantenimiento</span>
    <span class="arrow">▶</span>
   </li>
   <ul class="sub-menu">
    <li><a href="mantagregar.php">Agregar sensor</a></li>
    <li><a href="manteliminar.php">Eliminar sensor</a></li>
   </ul>
   <li class="anim-slide3" data-toggle="inst">
   ...
   <li class="anim-slide4" data-toggle="sen">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
    <span>Sensores</span>
    <span class="arrow">▶</span>
   </li>
   <ul class="sub-menu">
    <li><a href="senconfig.php">Configurar sensores</a></li>
   </ul>
   <li class="anim-slide5">
    <a href="historialtecnico.php">
...
<<<<<<< HEAD:tecnico/indextec.php
   <a href="../config/logout.php">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
    <span>Cerrar sesión</span>
   </a>
=======
  <a href="../cliente/indexcli.html">
   <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
   <span>Cerrar sesión</span>
  </a>
>>>>>>> caa1a26c99fecbe12f33d59cc2bf070cf7e3c880:tecnico/indextec.html
 </div>
</aside>
  ...
  <div class="header-right">
   ...
   <button class="theme-btn" id="themeToggle" title="Cambiar tema">
    ...
    <div class="user-dropdown" id="userDropdown">
     <div class="user-info">
      <div class="user-details"><div class="user-name">Técnico</div><div class="user-role">Soporte</div></div>
...
=======
     <div class="user-menu hidden" id="userMenu">
      <a class="user-menu-item" href="../cliente/indexcli.html">
       <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
       <span>Plebeyo</span>
      </a>
      <a class="user-menu-item" href="indextec.html">
   ...
   <div class="card anim-bounce1">
    ...
    <div class="quick-actions">
     ...
     <a class="quick-action" href="instprogramar.php">
      ...
      <div class="quick-action-text">Programar instalación</div>
     </a>
