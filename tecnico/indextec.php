...
<title>EVA - Dashboard TÃ©cnico</title>
...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   <li class="active anim-slide1"><a href="indextec.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg><span>Inicio</span></a></li>
...
<div class="main">
 <header class="header">
  <div class="header-left" style="display:flex;align-items:center;gap:12px"><button class="menu-btn" aria-label="Abrir menu"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button><div>
   <div class="header-greeting">Â¡Hola, <?php echo htmlspecialchars($_SESSION['nombre'] ?? 'TÃ©cnico'); ?>!</div>
   ...
   <button class="theme-btn" id="themeToggle" title="Cambiar tema">
    ...
    <div class="user-dropdown" id="userDropdown">
     <div class="user-info">
      <div class="user-details"><div class="user-name">TÃ©cnico</div><div class="user-role">Soporte</div></div>
 ...
 <div class="content">
  ...
  <div class="main-grid">
   <div class="card anim-bounce0">
    <div class="card-header"><div class="card-title">Estado de sensores</div></div>
   ...
   <div class="card anim-bounce1">
    <div class="card-header"><div class="card-title">Mantenimientos prÃ³ximos</div><a class="card-link" href="mantenimientos.php">Ver todos</a></div>
    <table class="table">
     <thead><tr><th>Tarea</th><th>UbicaciÃ³n</th><th>Fecha</th><th>Estado</th></tr></thead>
     <tbody>
  ...
  <div class="bottom-grid">
   ...
   <div class="card anim-bounce1">
    <div class="card-header"><div class="card-title">Acciones rÃ¡pidas</div></div>
    <div class="quick-actions">
     <a class="quick-action" href="mantagregar.php">
      <div class="quick-action-icon green">+</div>
      <div class="quick-action-text">Agregar sensor</div>
     </a>
     <a class="quick-action" href="manteliminar.php">
      <div class="quick-action-icon red">Ã—</div>
      <div class="quick-action-text">Eliminar sensor</div>
     </a>
     <a class="quick-action" href="instprogramar.php">
      <div class="quick-action-icon blue">ðŸ“…</div>
      <div class="quick-action-text">Programar instalaciÃ³n</div>
     </a>
     <a class="quick-action" href="instalar.php">
      <div class="quick-action-icon orange">âš™</div>
      <div class="quick-action-text">Instalar sistema EVA</div>
     </a>
    </div>
   </div>
  </div>
