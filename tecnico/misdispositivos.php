...
<div class="main">
 <header class="header">
  <div class="header-left" style="display:flex;align-items:center;gap:12px"><button class="menu-btn" aria-label="Abrir menu"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button><div><div class="header-greeting">Mis Dispositivos</div><div class="header-subtitle">Dispositivos asignados a tu cuenta</div></div></div>
    ...
    <div class="dispositivo-card" data-estado="<?php echo $badge['data']; ?>">
     ...
     <div class="dispositivo-card-body">
      <div class="dispositivo-info-grid">
       <div class="dispositivo-info-item"><span class="dispositivo-info-label">NÂ° Serie</span><span class="dispositivo-info-val"><?php echo htmlspecialchars($serie); ?></span></div>
       ...
       <div class="dispositivo-info-item"><span class="dispositivo-info-label">BaterÃ­a</span><span class="dispositivo-info-val"><?php echo $bateria; ?>%</span></div>
       <div class="dispositivo-info-item"><span class="dispositivo-info-label">SeÃ±al</span><span class="dispositivo-info-val"><?php echo $senal; ?> dBm</span></div>
       <div class="dispositivo-info-item"><span class="dispositivo-info-label">Ãšltima conexiÃ³n</span><span class="dispositivo-info-val"><?php echo $ultimaConn; ?></span></div>
     ...
     <div class="dispositivo-observaciones">
      <textarea class="form-input" placeholder="Agregar observaciones tÃ©cnicas..." rows="2"></textarea>
 ...
 <div class="modal">
  ...
  <div class="modal-body">
   <table class="table">
    ...
    <tbody>
     <tr><td colspan="3" style="text-align:center;color:var(--tx4)">SeleccionÃ¡ un dispositivo para ver su historial</td></tr>
    </tbody>
   </table>
  </div>
 </div>
