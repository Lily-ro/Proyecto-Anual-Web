...
<div class="main">
 <header class="header">
  <div class="header-left"><div class="header-greeting">Eliminar Sensor</div><div class="header-subtitle">Retira un sensor del sistema</div></div>
 ...
 <div class="content">
  <div class="content-card anim-bounce0">
   ...
   <div class="form-group"><label class="form-label">Sensor a eliminar</label><select class="form-select"><option>Sensor Ultrasónico 04</option><option>Sensor Presión 02</option><option>Sensor Nivel 03</option><option>Sensor Temperatura 01</option></select></div>
   <div class="form-group"><label class="form-label">Motivo de eliminación</label><select class="form-select"><option>Dañado</option><option>Reemplazado</option><option>Obsoleto</option><option>Otro</option></select></div>
