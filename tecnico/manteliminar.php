...
<title>EVA - Eliminar Sensor</title>
...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <ul class="sub-menu open"><li><a href="mantagregar.php">Agregar sensor</a></li><li><a href="manteliminar.php" style="font-weight:600">Eliminar sensor</a></li></ul>
...
<div class="main">
 <header class="header">
  <div class="header-left" style="display:flex;align-items:center;gap:12px"><button class="menu-btn" aria-label="Abrir menu"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button><div><div class="header-greeting">Eliminar Sensor</div><div class="header-subtitle">Retira un sensor del sistema</div></div></div>
 ...
 <div class="content">
  <div class="content-card anim-bounce0">
   <div class="card-title">Eliminar Sensor</div>
   <div class="card-subtitle">Selecciona el sensor que deseas retirar del sistema</div>
   <div class="content-divider"></div>
   <div class="form-group"><label class="form-label">Sensor a eliminar</label><select class="form-select"><option>Sensor UltrasÃ³nico 04</option><option>Sensor PresiÃ³n 02</option><option>Sensor Nivel 03</option><option>Sensor Temperatura 01</option></select></div>
   <div class="form-group"><label class="form-label">Motivo de eliminaciÃ³n</label><select class="form-select"><option>DaÃ±ado</option><option>Reemplazado</option><option>Obsoleto</option><option>Otro</option></select></div>
   <div class="actions-row"><button class="btn btn-danger">Eliminar Sensor</button><button class="btn btn-outline">Cancelar</button></div>
  </div>
 </div>
</div>
