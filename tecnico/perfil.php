...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <li class="active anim-slide6"><a href="perfil.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg><span>Perfil</span></a></li>
  </ul>
 </nav>
...
<div class="main">
 <header class="header">
  <div class="header-left"><div class="header-greeting">Mi Perfil</div><div class="header-subtitle">Información personal y configuración de cuenta</div></div>
 ...
 <div class="content">
  <div class="content-card anim-bounce0">
   <div class="profile-header">
    ...
    <div class="profile-info"><div class="profile-name">Carlos Técnico</div><div class="profile-role">Soporte Técnico - Nivel 2</div></div>
   </div>
   <div class="content-divider"></div>
   <div class="profile-section">
    <div class="profile-section-title">Información Personal</div>
    <div class="profile-field"><div class="profile-field-label">Nombre completo</div><div class="profile-field-value">Carlos Técnico</div></div>
    <div class="profile-field"><div class="profile-field-label">Correo electrónico</div><div class="profile-field-value">carlos.tecnico@eva.com</div></div>
    <div class="profile-field"><div class="profile-field-label">Teléfono</div><div class="profile-field-value">+54 11 1234-5678</div></div>
    <div class="profile-field"><div class="profile-field-label">Rol</div><div class="profile-field-value">Técnico - Soporte Nivel 2</div></div>
   ...
   <div class="actions-row"><button class="btn btn-primary">Editar Perfil</button><button class="btn btn-outline">Cambiar Contraseña</button></div>
  </div>
 </div>
</div>
