...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <li class="active anim-slide11"><a href="perfil.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg><span>Perfil</span></a></li>
  </ul>
 </nav>
...
<div class="main">
 <header class="header">
  <div class="header-left" style="display:flex;align-items:center;gap:12px"><button class="menu-btn" aria-label="Abrir menu"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button><div><div class="header-greeting">Mi Perfil</div><div class="header-subtitle">InformaciÃ³n personal y configuraciÃ³n de cuenta</div></div></div>
 ...
 <div class="content">
  <div class="content-card anim-bounce0">
   <div class="profile-header">
    ...
    <div class="profile-info"><div class="profile-name">Carlos TÃ©cnico</div><div class="profile-role">Soporte TÃ©cnico - Nivel 2</div></div>
   </div>
   <div class="content-divider"></div>
   <div class="profile-section">
    <div class="profile-section-title">InformaciÃ³n Personal</div>
    <div class="profile-field"><div class="profile-field-label">Nombre completo</div><div class="profile-field-value">Carlos TÃ©cnico</div></div>
    <div class="profile-field"><div class="profile-field-label">Correo electrÃ³nico</div><div class="profile-field-value">carlos.tecnico@eva.com</div></div>
    <div class="profile-field"><div class="profile-field-label">TelÃ©fono</div><div class="profile-field-value">+54 11 1234-5678</div></div>
    <div class="profile-field"><div class="profile-field-label">Rol</div><div class="profile-field-value">TÃ©cnico - Soporte Nivel 2</div></div>
    <div class="profile-field"><div class="profile-field-label">Zona de cobertura</div><div class="profile-field-value">Zona Norte</div></div>
   </div>
   <div class="profile-section">
    <div class="profile-section-title">EstadÃ­sticas</div>
    <div class="profile-field"><div class="profile-field-label">Mantenimientos realizados</div><div class="profile-field-value">15</div></div>
    <div class="profile-field"><div class="profile-field-label">Instalaciones completadas</div><div class="profile-field-value">8</div></div>
    <div class="profile-field"><div class="profile-field-label">Sensores configurados</div><div class="profile-field-value">24</div></div>
   </div>
   <div class="actions-row"><button class="btn btn-primary">Editar Perfil</button><button class="btn btn-outline">Cambiar ContraseÃ±a</button></div>
  </div>
 </div>
</div>
