...
<title>EVA - Programar Instalación</title>
...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <ul class="sub-menu open"><li><a href="instprogramar.php" style="font-weight:600">Programar instalación</a></li><li><a href="instalar.php">Instalar sistema EVA</a></li></ul>
...
<div class="main">
 <header class="header">
  <div class="header-left"><div class="header-greeting">Programar Instalación</div><div class="header-subtitle">Agenda una nueva instalación de sistema EVA</div></div>
 ...
 <div class="content">
  <div class="content-card anim-bounce0">
   <div class="card-title">Programar Instalación</div>
   <div class="card-subtitle">Completa los datos para agendar una instalación</div>
   ...
   <div class="form-row">
    ...
    <div class="form-group"><label class="form-label">Ubicación</label><input class="form-input" type="text" placeholder="Dirección o zona"></div>
   </div>
   <div class="form-row">
