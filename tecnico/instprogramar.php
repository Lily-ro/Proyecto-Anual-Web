...
<title>EVA - Programar InstalaciÃ³n</title>
...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <ul class="sub-menu open"><li><a href="instprogramar.php" style="font-weight:600">Programar instalaciÃ³n</a></li><li><a href="instalar.php">Instalar sistema EVA</a></li></ul>
...
<div class="main">
 <header class="header">
  <div class="header-left" style="display:flex;align-items:center;gap:12px"><button class="menu-btn" aria-label="Abrir menu"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button><div><div class="header-greeting">Programar InstalaciÃ³n</div><div class="header-subtitle">Agenda una nueva instalaciÃ³n de sistema EVA</div></div></div>
 ...
 <div class="content">
  <div class="content-card anim-bounce0">
   <div class="card-title">Programar InstalaciÃ³n</div>
   <div class="card-subtitle">Completa los datos para agendar una instalaciÃ³n</div>
   <div class="content-divider"></div>
   <div class="form-row">
    <div class="form-group"><label class="form-label">Cliente</label><input class="form-input" type="text" placeholder="Nombre del cliente"></div>
    <div class="form-group"><label class="form-label">UbicaciÃ³n</label><input class="form-input" type="text" placeholder="DirecciÃ³n o zona"></div>
   </div>
   <div class="form-row">
    <div class="form-group"><label class="form-label">Fecha</label><input class="form-input" type="date"></div>
    <div class="form-group"><label class="form-label">Hora</label><input class="form-input" type="time"></div>
   </div>
   <div class="form-group"><label class="form-label">Notas</label><textarea class="form-input" rows="3" placeholder="Observaciones o instrucciones adicionales..."></textarea></div>
   <div class="actions-row"><button class="btn btn-primary">Programar</button><button class="btn btn-outline">Cancelar</button></div>
  </div>
 </div>
</div>
