...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <li class="open anim-slide3" data-toggle="inst"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg><span>Instalación</span><span class="arrow">▶</span></li>
   <ul class="sub-menu open">
    <li><a href="instprogramar.php" style="font-weight:600">Programar instalación</a></li>
    <li><a href="instalar.php">Instalar sistema EVA</a></li>
   </ul>
