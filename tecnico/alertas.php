...
$mapTipo = [
    ...
    'SIN_CONEXION'     => ['txt'=>'Sin conexiÃ³n','prio'=>'critica','prioTxt'=>'CrÃ­tica'],
    'FALLA_SENSOR'     => ['txt'=>'Falla de sensor','prio'=>'critica','prioTxt'=>'CrÃ­tica'],
...
<div class="main">
 <header class="header">
  <div class="header-left" style="display:flex;align-items:center;gap:12px"><button class="menu-btn" aria-label="Abrir menu"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button><div><div class="header-greeting">Alertas</div><div class="header-subtitle">Alertas de tus dispositivos asignados</div></div></div>
 ...
 <div class="content">
  <div class="stats-row">
   ...
   <div class="stat-card anim-bounce3">
    ...
    <div class="stat-card-info">
     <div class="stat-card-title">CrÃ­ticas</div>
  ...
  <div class="content-card anim-bounce0">
   <div class="card-header">
    ...
    <div class="filtros-inline">
     <select class="form-select filtros-select" id="filtrarPrioridad">
     ...
     <select class="form-select filtros-select" id="filtrarEstadoAlerta">
...
<div class="modal-overlay hidden" id="modalAlerta">
 <div class="modal">
  <div class="modal-header">
   <div class="modal-title">Detalle de alerta</div>
   <button class="modal-close" onclick="cerrarModal('modalAlerta')">&times;</button>
  </div>
  <div class="modal-body">
   ...
   <div class="form-group">
    <label class="form-label">Comentario tÃ©cnico</label>
    <textarea class="form-input" id="comentarioTecnico" placeholder="Agregar comentario sobre la alerta..." rows="3"></textarea>
   </div>
   <div class="form-group">
    <label class="form-label">SoluciÃ³n aplicada</label>
    <textarea class="form-input" id="solucionAplicada" placeholder="Describir la soluciÃ³n aplicada..." rows="3"></textarea>
   </div>
   <div class="actions-row">
    <button class="btn btn-primary" onclick="marcarAtendida()">Marcar como atendida</button>
    <button class="btn btn-outline" onclick="cerrarModal('modalAlerta')">Cerrar</button>
   </div>
  </div>
 </div>
</div>
