...
<div class="main">
 <header class="header">
  <div class="header-left"><div class="header-greeting">Alertas</div><div class="header-subtitle">Alertas de tus dispositivos asignados</div></div>
 ...
 <div class="modal">
  ...
  <div class="modal-body">
   ...
   <div class="form-group">
    ...
    <textarea class="form-input" id="solucionAplicada" placeholder="Describir la solución aplicada..." rows="3"></textarea>
   </div>
