...
<title>EVA - Instalar Sistema EVA</title>
...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <li class="anim-slide5" data-toggle="mant"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"/></svg><span>Mantenimiento</span><span class="arrow">â–¶</span></li>
   <ul class="sub-menu"><li><a href="mantagregar.php">Agregar sensor</a></li><li><a href="manteliminar.php">Eliminar sensor</a></li></ul>
   <li class="open anim-slide6" data-toggle="inst"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg><span>InstalaciÃ³n</span><span class="arrow">â–¶</span></li>
   <ul class="sub-menu open"><li><a href="instprogramar.php">Programar instalaciÃ³n</a></li><li><a href="instalar.php" style="font-weight:600">Instalar sistema EVA</a></li></ul>
...
<div class="main">
 <header class="header">
  <div class="header-left" style="display:flex;align-items:center;gap:12px"><button class="menu-btn" aria-label="Abrir menu"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button><div><div class="header-greeting">Instalar Sistema EVA</div><div class="header-subtitle">Realiza la instalaciÃ³n de un sistema EVA</div></div></div>
 ...
 <div class="content">
  <div class="content-card anim-bounce0">
   <div class="card-title">Instalar Sistema EVA</div>
   <div class="card-subtitle">Selecciona el sistema programado para instalar</div>
   <div class="content-divider"></div>
   <div class="form-row">
    <div class="form-group"><label class="form-label">InstalaciÃ³n programada</label><select class="form-select"><option>Tanque Norte - 15/05/2025</option><option>Tanque Centro - 16/05/2025</option><option>Tanque Sur - 17/05/2025</option></select></div>
    <div class="form-group"><label class="form-label">Estado de instalaciÃ³n</label><select class="form-select"><option>En progreso</option><option>Completada</option><option>Retrasada</option></select></div>
   </div>
   <div class="form-group"><label class="form-label">Notas de instalaciÃ³n</label><textarea class="form-input" rows="3" placeholder="Describe el progreso o incidencias..."></textarea></div>
   <div class="actions-row"><button class="btn btn-primary">Registrar InstalaciÃ³n</button><button class="btn btn-outline">Cancelar</button></div>
  </div>
 </div>
</div>
