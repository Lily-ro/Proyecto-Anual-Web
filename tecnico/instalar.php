...
<aside class="sidebar">
 ...
 <nav>
  <ul>
   ...
   <li class="open anim-slide6" data-toggle="inst"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg><span>Instalación</span><span class="arrow">▶</span></li>
   <ul class="sub-menu open"><li><a href="instprogramar.php">Programar instalación</a></li><li><a href="instalar.php" style="font-weight:600">Instalar sistema EVA</a></li></ul>
...
<div class="main">
 <header class="header">
  <div class="header-left"><div class="header-greeting">Instalar Sistema EVA</div><div class="header-subtitle">Realiza la instalación de un sistema EVA</div></div>
 ...
 <div class="content">
  <div class="content-card anim-bounce0">
   ...
   <div class="form-row">
    <div class="form-group"><label class="form-label">Instalación programada</label><select class="form-select"><option>Tanque Norte - 15/05/2025</option><option>Tanque Centro - 16/05/2025</option><option>Tanque Sur - 17/05/2025</option></select></div>
    <div class="form-group"><label class="form-label">Estado de instalación</label><select class="form-select"><option>En progreso</option><option>Completada</option><option>Retrasada</option></select></div>
   </div>
   <div class="form-group"><label class="form-label">Notas de instalación</label><textarea class="form-input" rows="3" placeholder="Describe el progreso o incidencias..."></textarea></div>
   <div class="actions-row"><button class="btn btn-primary">Registrar Instalación</button><button class="btn btn-outline">Cancelar</button></div>
  </div>
 </div>
</div>
