...
function badgeEstadoDev($estado){ $map=['ONLINE'=>['cls'=>'activo','txt'=>'Conectado'],'OFFLINE'=>['cls'=>'inactivo','txt'=>'Desconectado'],'MANTENIMIENTO'=>['cls'=>'advertencia','txt'=>'Mantenimiento']]; $info=$map[$estado]??['cls'=>'inactivo','txt'=>($estado==='ONLINE'?'Conectado':($estado==='OFFLINE'?'Desconectado':$estado))]; return '<span class="badge '.$info['cls'].'">'.htmlspecialchars($info['txt']).'</span>'; }
     ...
     <div class="card-header">
      <form method="GET" class="filters-row">
       ...
       <div class="filter-group"><input type="text" name="busqueda" class="filter-input" placeholder="Buscar dispositivo..." value="<?php echo htmlspecialchars($filtroBusqueda); ?>"></div>
        <div class="filter-group"><select name="estado" class="filter-input"><option value="">Todos los estados</option><option value="ONLINE"<?php echo $filtroEstado==='ONLINE'?' selected':''; ?>>Conectado</option><option value="OFFLINE"<?php echo $filtroEstado==='OFFLINE'?' selected':''; ?>>Desconectado</option><option value="MANTENIMIENTO"<?php echo $filtroEstado==='MANTENIMIENTO'?' selected':''; ?>>Mantenimiento</option></select></div>
